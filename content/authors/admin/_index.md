...
education:
  - area: B.S. in Information Management and Information Systems
...
skills:
  ...
  - name: Hobbies
    ...
    color_border: '#f0bf23'
    items:
      - name: Hiking in the Forests
        description: ''
        percent: 80
        icon: person-simple-walk
      - name: Making Home bake
        description: ''
        percent: 90
        icon: bread
      - name: Reading Books
...
I am an undergraduate researcher at the China University of Geosciences (Beijing). 
